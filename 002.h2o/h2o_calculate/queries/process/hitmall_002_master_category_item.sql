...
with tt001 as(
  ...
  where
    (site_name = 'BEAUTY' and category_id rlike '^b_bbs_(ccnl|hhrm|kdcr|pdio|scpb)_[a-z0-9_]*')
...
tt002 as(
  ...
  from
    ${database_name.l0_non_all_hitmall}.hm_master_category
  where
    category_id rlike 'bi_[a-z0-9]*_[a-z0-9]*$'
),
...
tt003 as(
  ...
  from
    ${database_name.l0_non_all_hitmall}.hm_master_category
  where
    category_id rlike 'bi_[a-z0-9]*_[a-z0-9]*_[a-z0-9]*$'
)
